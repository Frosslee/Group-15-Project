...
namespace Tello_Interface {
    ...
    public partial class Db : global::System.Data.DataSet {
        ...
        public partial class LoginTableDataTable : global::System.Data.TypedTableBase<LoginTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LoginTableRow AddLoginTableRow(string username, string password, int level) {
        ...
        public partial class LoginTableRow : global::System.Data.DataRow {
            ...
            public int level {
                get {
                    try {
                        return ((int)(this[this.tableLoginTable.levelColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'level\' in table \'LoginTable\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableLoginTable.levelColumn] = value;
                }
            }
            ...
            public bool IslevelNull() {
                return this.IsNull(this.tableLoginTable.levelColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetlevelNull() {
                this[this.tableLoginTable.levelColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Tello_Interface.DbTableAdapters {
    ...
    public partial class LoginTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoginTable] WHERE (([Id] = @Original_Id) AND ([username] = @Or" +
                "iginal_username) AND ([password] = @Original_password) AND ((@IsNull_level = 1 A" +
                "ND [level] IS NULL) OR ([level] = @Original_level)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LoginTable] ([username], [password], [level]) VALUES (@usernam" +
                "e, @password, @level);\r\nSELECT Id, username, password, level FROM LoginTable WHE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LoginTable] SET [username] = @username, [password] = @password, [level] = @level WHERE (([Id] = @Original_Id) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ((@IsNull_level = 1 AND [level] IS NULL) OR ([level] = @Original_level)));
SELECT Id, username, password, level FROM LoginTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Tello_Interface.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password, [level] FROM dbo.LoginTable";
        ...
        public virtual int Fill(Db.LoginTableDataTable dataTable) {
        ...
        public virtual Db.LoginTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Db.LoginTableDataTable dataTable = new Db.LoginTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Db.LoginTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, global::System.Nullable<int> Original_level) {
        ...
        public virtual int Insert(string username, string password, global::System.Nullable<int> level) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, global::System.Nullable<int> level, int Original_Id, string Original_username, string Original_password, global::System.Nullable<int> Original_level, int Id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, global::System.Nullable<int> level, int Original_Id, string Original_username, string Original_password, global::System.Nullable<int> Original_level) {
            return this.Update(username, password, level, Original_Id, Original_username, Original_password, Original_level, Original_Id);
        }
    }
